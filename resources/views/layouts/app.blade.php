        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('dashboard') }}" class="b-brand text-primary">
                    ...
                    <h4 class="bg-light-success rounded-pill ms-2">My Pos</h4>
                </a>
            </div>
            <div class="navbar-content">
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="../pages/login-v1.html" class="pc-link"><span class="pc-micon">
                                <svg class="pc-icon">
                                    <use xlink:href="#custom-shield"></use>
                                </svg> </span><span class="pc-mtext">Login</span></a>
                    </li>
                    <li class="pc-item">
                        <a href="../pages/register-v1.html" class="pc-link"><span class="pc-micon">
                                <svg class="pc-icon">
